...
<html>
    ...
    <script>document.ondragstart = function () { return false; };</script>
        ...
        <!-- NOTIFICATION -->
        <div id="notification" style="border: 1px solid black; width: 210px; height: 225px"></div>
        <div id="event-watcher" style="border: 1px solid black; width: 230px; height: 180px"></div>
        <div id="utility" style="border: 1px solid black; width: 450px; height: 30px;"></div>
	</body>
</html>
)
